...
//Credit to Tim Holman for the loading animation
class ProcessPage extends React.Component {
  ...
  handleChange (evt) {
	...
	render(){
    const { alert,module,user } = this.props;
		return (
      <div>
        <p className="process-header">Hi {user.name}, we're getting things ready for you.</p>
        <div class="preloader">
          <svg version="1.1" id="sun" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enable-background="new 0 0 10 10">
            <g>
...
const connectedProcessPage = connect(mapStateToProps)(ProcessPage);
export default connectedProcessPage;
